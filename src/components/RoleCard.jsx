...
export default function RoleCard({ icon: Icon, title, description, features, to, delay = 0 }) {
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className="group flex flex-col gap-5 rounded-xl2 border border-black/8 bg-white p-7 shadow-card transition-shadow hover:shadow-lift"
    >
      ...
      <Link to={to} className="mt-auto flex items-center gap-1.5 text-sm font-semibold text-emerald-600 transition-transform group-hover:translate-x-1">
